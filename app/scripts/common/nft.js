...
function getNftsInfo(tokenIds, callback, onlyNft = true) {
  var jqxhr = $.post(
    ERGEXPLORER_API_HOST + "tokens/byId",
    {
      onlyNft: onlyNft,
      ids: tokenIds,
    },
...
function getIssuedNfts(address, callback) {
  var jqxhr = $.get(
    ERGEXPLORER_API_HOST + "tokens/byIssuedAddress",
    {
      onlyNft: true,
      address: address,
    },
...
function processNftData(nftData) {
  ...
  let typeString =
    nftData.additionalRegisters == undefined ||
    nftData.additionalRegisters.R7 == undefined ||
    nftData.additionalRegisters.R7.serializedValue == null
      ? undefined
      : nftData.additionalRegisters.R7.serializedValue;
  let hash =
    nftData.additionalRegisters == undefined ||
    nftData.additionalRegisters.R8 == undefined ||
    nftData.additionalRegisters.R8.renderedValue == null
      ? undefined
      : nftData.additionalRegisters.R8.renderedValue;
  let tempLink =
    nftData.additionalRegisters == undefined ||
    nftData.additionalRegisters.R9 == undefined ||
    nftData.additionalRegisters.R9.renderedValue == null
      ? undefined
      : nftData.additionalRegisters.R9.renderedValue.split(",");
