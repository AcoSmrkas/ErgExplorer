...
function lint() {
  return doLint("app/scripts/**/*.js").pipe(gulp.dest("app/scripts"));
}
...
function scriptsbuild() {
  return gulp
    .src(["app/scripts/**/*.js", "!app/scripts/common/token-icons.js"])
...
function scriptsmove() {
  return gulp
    .src("app/scripts/common/token-icons.js")
...
function fonts() {
  return gulp
    .src("app/fonts/*", { encoding: false })
    .pipe(gulp.dest("dist/fonts"));
}

function stylescss() {
  return gulp.src("app/styles/**/*.css").pipe(gulp.dest("dist/styles"));
}
