...
export function applyThemeVariables(theme = 'light') {
	...
	root.style.setProperty('--main-color', selectedTheme.primary || themeConfig.colors.primary);
	root.style.setProperty('--main-color-hover', selectedTheme.primaryHover || themeConfig.colors.primaryHover);
