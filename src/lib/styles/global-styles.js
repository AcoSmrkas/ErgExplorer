...
export const patterns = {
  ...
  // Glass effect cards
  glassCard: compose("glass", "u-rounded-md", "p-3", "u-transition"),
  ...
  glassNavbar: compose("glass-subtle", "u-transition"),

  // Centered loading state
  loading: compose(css.flex.center, "min-h-48 text-muted"),

  // Error state
  error: compose(css.flex.center, "min-h-48 text-danger"),

  // Statistics display
  statCard: compose(css.card.summary, css.text.center, "mb-3"),
  ...
  // Navigation item
  navItem: compose("nav-link", "transition-colors duration-200"),

  // Data table
  dataTable: compose(css.table.default, css.table.responsive, "border-no-flat"),
  ...
  glassTableHeader: compose("glass-accent", "u-font-semibold"),

  glassTableRow: compose("glass-subtle", "u-transition"),
