...
import { nFormatter, formatNumber as formatNum, formatPercentage, formatHashRate as formatHashRateUtil } from './numberFormatting.js';

export const ERG_SPAN = ' <span class="erg-span">ERG</span>';

export function formatErgValue(value, decimals = ERG_DECIMALS, showDecimals = true) {
	...
	return ergValue.toLocaleString(undefined, {
