...
type LayoutRouteId = RouteId | "/" | "/about" | "/addressbook" | "/addresses/[address]" | "/blocks/[id]" | "/issued-tokens" | "/latest-blocks" | "/mempool" | "/tokens/[tokenId]" | "/transactions/[txId]" | null
type LayoutParams = RouteParams & { address?: string; id?: string; tokenId?: string; txId?: string }
